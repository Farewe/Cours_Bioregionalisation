...
Cette année, j'ai facilité la tâche en écrivant des fonctions dédiées dans le package `bioregion` ʕ•́ᴥ•̀ʔっ.
...
**Nouveauté octobre 2025** : utilisez `bioregion_colors()` pour générer une palette de couleurs distinctes pour chaque cluster. 
...
Pour pouvoir analyser le réseau sous gephi, il faut écrire un fichier sur le disque dans un format particulier, en .gdf. C'est une opération assez complexe à réaliser, mais **nouveauté octobre 2025** : j'ai écrit une fonction pour vous faciliter la vie !

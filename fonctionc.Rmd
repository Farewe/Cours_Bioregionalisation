...
coph.subtidal <- as.matrix(cophenetic(tree.subtidal$cons))
...
axis(1, 
     at = seq(max(cophenetic(tree.subtidal$cons)), 0, 
              by = -round(max(cophenetic(tree.subtidal$cons))/4, 2)) / 2,
     labels = seq(0, max(cophenetic(tree.subtidal$cons)), 
                  by = round(max(cophenetic(tree.subtidal$cons))/4, 2)))
```

...
# Shapefiles
basins <- readOGR("./data/data_cours/basin_simplif.shp")
...
```{r}
basins@data$color1 <- fish.net1$color[match(basins@data$BasinName, fish.net1$Name)]
...
basins@data$color2 <- fish.net2$color[match(basins@data$BasinName, fish.net2$Name)]
